...
Si JavaFX no encuentra un archivo \textcolor{codigo}{\texttt{fxml}} puedes obtener el siguiente mensaje de error:\\
\textcolor{codigo}{\texttt{java.lang.IllegalStateException: Location is not set.}}\\
Para resolverlo comprueba otra vez que no hayas escrito mal el nombre de tus archivos \textcolor{codigo}{\texttt{fxml}}.
